...
function copyArray (magicArray:string[]){
...
function carInformation (manufacturer: string , modelName : string , ...optional :{[key:string] : any } [] ): object {
    let car = {
        manufacturer,
        modelName,
...
let pricesSet1:number[] = [1100, 300, 1800, 600];

let pricesSet2: number[] = [1900, 550, 1400, 800];

let combinedArray:number[] = [...pricesSet1,...pricesSet2];
